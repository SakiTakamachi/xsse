...
static void test_mm_max_epu8(void **state)
{
	...
	uint8_t expected[16] = { 100, 100, 100, 100, 100, 100, 200, 200, 100, 100, 100, 100, 100, 100, 50, 200 };
	uint8_t actual[16];
...
static void test_mm_max_epu16(void **state)
{
	...
	uint16_t expected[8] = { 100, 100, 100, 100, 100, 100, 200, 200 };
	uint16_t actual[8];
	_mm_storeu_si128((__m128i*) actual, result);
...
static void test_mm_max_epu32(void **state)
{
	...
	uint32_t expected[4] = { 100, 100, 200, 200 };
	uint32_t actual[4];
	_mm_storeu_si128((__m128i*) actual, result);
