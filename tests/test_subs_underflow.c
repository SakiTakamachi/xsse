...
static void test_mm_subs_epi8_underflow(void **state)
{
	(void) state;
...
static void test_mm_subs_epi16_underflow(void **state)
{
	(void) state;
...
static void test_mm_subs_epu8_underflow(void **state)
{
	(void) state;
...
static void test_mm_subs_epu16_underflow(void **state)
{
	(void) state;
