...
static void test_mm_adds_epi8_basic(void **state)
{
	(void) state;
...
static void test_mm_adds_epi16_basic(void **state)
{
	(void) state;
...
static void test_mm_adds_epu8_basic(void **state)
{
	(void) state;
...
static void test_mm_adds_epu16_basic(void **state)
{
	(void) state;
...
int main(void)
{
	const struct CMUnitTest tests[] = {
		cmocka_unit_test(test_mm_adds_epi8_basic),
		cmocka_unit_test(test_mm_adds_epi16_basic),
		cmocka_unit_test(test_mm_adds_epu8_basic),
		cmocka_unit_test(test_mm_adds_epu16_basic)
	};
