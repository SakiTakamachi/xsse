...
#ifdef XSSE4_1
	__m128i x = _mm_setr_epi8(10, 20, 30, 40, 50, 60, 70, UINT8_MAX, 11, 12, 13, 14, 15, 16, 17, 18);
...
#ifdef XSSE4_1
	__m128i x = _mm_setr_epi8(10, 20, 30, UINT8_MAX, 50, 60, 70, 80, 11, 12, 13, 14, 15, 16, 17, 18);
...
#ifdef XSSE4_1
	__m128i x = _mm_setr_epi8(10, UINT8_MAX, 30, 40, 50, 60, 70, 80, 11, 12, 13, 14, 15, 16, 17, 18);
...
#ifdef XSSE4_1
	__m128i x = _mm_setr_epi16(10, 20, 30, UINT16_MAX, 50, 60, 70, 80);
...
#ifdef XSSE4_1
	__m128i x = _mm_setr_epi16(10, UINT16_MAX, 30, 40, 50, 60, 70, 80);
...
#ifdef XSSE4_1
	__m128i x = _mm_setr_epi32(10, UINT32_MAX, 30, 40);
